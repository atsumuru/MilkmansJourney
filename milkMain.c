...
{						   // hp money
  ...
  int *money = &stats.money; // <---
	...
	printf("One day, you wake up to find that all your milk was gone. You groan as you head off to the store to get "
          "more. While watching a random video your friend sent you,\nyou walk into the street, not realizing the light"
          ...
          "need to get milk. You throw yourself out of bed and begin your journey to the store to\nget a jug of milk.\n\n"); 

  fprintf(f, "One day, you wake up to find that all your milk was gone. You groan as you head off to the store to get "
          "more. While watching a random video your friend sent you,\nyou walk into the street, not realizing the light"
          " had just turned green. You turn your head just in time to see a semi honk its horn at you before everything "
          "goes black.\n\nWhen you wake, you find yourself at home in your bed. What had happened? How did you get home? "
          "How did you survive? Are you dead!?!\nWho are you kidding, you don't care. All you know is that you still "
	...
	while(exit == 'n' || *health < 1 || *money < 1); 
	{  
		*health = 20; 
		*money = 100;
	  printf("You start with %d Hp and %d dollars in your wallet as you leave your house.\n\n", *health, *money); 
		...
		{ 
					...
					if (*health >= 1 || *money >= 1)
          {
				...
				{ 
					grilledRoute(health, money, &invent);
					selection_list[1] = 0;  
          if (*health >= 1 || *money >= 1)
          {
					  exit = quit(); 
        ...
        {
          umbrellaRoute(health, money, &invent);
          selection_list[2] = 0;
          if (*health >= 1 || *money >= 1)
          {
					  exit = quit(); 
        ...
        {
          chickenRoute(health, money, &invent);
          selection_list[3] = 0;
          if (*health >= 1 || *money >= 1)
          {
					  exit = quit(); 
    ...
    if (exit != 'n' || *health >= 1 || *money >= 1)
    {
      ...
      fprintf(f, "After a daring journey, you finally make it to the store... only to find that it's closed. You then spot a lone cartoon of milk"
            " sitting by the door. A tear comes to your eye as you think that this was a higher being's blessing for\nyour troubles. "
            "You pick up the milk, but upon closer inspection, you realize that it was soy milk. A look of utter disdain forms on"
            " your face as you drop the milk and walk out into the street. You spread yours arms and fall into\nthe path of an incoming truck."
            "\n\nYou wake up back in your house and you begrudgingly roll out bed, ready to do all of that again.\n\nHere we go again...\n");
    ...
    fprintf(f, "You feel your extremites start to shake as you fall over and start foaming at the mouth.\n\n"
					"You got the [Rabies Ending]!\n");
	}
	else if(*money == -150)
	{
    ...
    fprintf(f, "You take the child under your care and become their surrogate parent.\n\n"
					"You got the [Parent Ending]!\n");
	}
	else if(*health == -1083)
	{
    ...
    fprintf(f, "After years of managing the milk supply with Johnny for his dairy business\n"
			   "You come up with a bold new strategy: Normalize the drinking of raw milk in this world.\n"
			   "By making fresh milk readily available for purchase on the open market, you reduce Milk-Dealing"
			   " related crimes and also introduce the population to your favourite beverage.\nIt also improves"
			   " sales for Johnny's company (to which he's recently been appointed as CEO).\nIn honour of this grand"
    ...
    fprintf(f, "You decide that all of this isn't worth the milk.\n\nYou walk back home and live out the rest of your life, milkless.\n\n"
					"You got the [Neutral Ending]!\n");
	} 
  else if(*health < 1)
  {
    printf("You feel your heart give out as you collaspe onto the ground, dead. How did this happen?? You were just supposed to get milk!!"
          "\n\nYou got the [Dead Ending]!\n"); 
    fprintf(f, "You feel your heart give out as you collaspe onto the ground, dead. How did this happen?? You were just supposed to get milk!!"
          "\n\nYou got the [Dead Ending]!\n"); 
  } 
  else if(*money < 1)
  {
    printf("You check your wallet and a literal moth flies out. You feel your soul leave your body as you collapse to your hands and knees."
          "You can no longer buy milk.\n\nYou got the [Broke Ending]!\n"); 
    fprintf(f, "You check your wallet and a literal moth flies out. You feel your soul leave your body as you collapse to your hands and knees."
          "You can no longer buy milk.\n\nYou got the [Broke Ending]!\n"); 
  }
