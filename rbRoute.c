...
void festival(int* m, INVENTORY* i)
{
	int c = 1;
	int molePos = 0;
	int turn = 1;
	...
	printf("Today is Charlotte's birthday. To celebrate, you go with her to"
	       ...
	       " you realized was just carbonated water with white food dye. You"
	...
	printf("\e[1;33mPLEASE! We've got to try it! Don't you see the prizes?\n"
	       ...
	       " mascot. It seems your question will forever remain unanswered.\n"
	       ...
	       " her. After all, it's her birthday, and you have yet to buy her a "
	       "proper gift.\n");
		...
		if(c==1&&*m>=10)
		{
			*m -= 10;
			printf("\e[0mYou purchase tickets for both youreslf and Charlotte.\n"
			       ...
			       " hit the mole may or may not change positions. You're allowed"
			...
			if (hits==4)
			{
				...
				printf("Congratulations! You've earned the top prize!\nThe man "
				       ...
				       "happy to see Charlotte smile. But she insisted she at least"
...
void job(int* hp, int* money)
{
	...
	printf("\e[1;33mI've got another job for you today.\n");

	switch(k)
	{
	//brawl (rock-paper-scissors style minigame, best of three.)
	case 0:
		printf("\e[0mToday's job: Brawl.");
		...
		if(*hp<=0&&enemyHP>0)
		{
			printf("You are knocked unconscious. Charlotte carries you back to the penthouse.\n"
			       "After some rest, your HP is restored to 50.\n");
			*hp=50;
		}
	...
	case 1:
		...
		*money+=25;
		...
		{
			printf("You currently have $%d", *money);
			printf("\e[1;34mWould you like to gamble?\n(1) Yes\n(2) No\n");
			choice=inp(1,1,2);
			printf("\e[0m");
			if (choice==1)
			{
				printf("How much money would you like gamble?\n(1) $25\n(2) $50\n(3) Life Savings\n");
				gamble = inp(1,2,3);
			...
			printf("After having gambled to your heart's content, you return to the penthouse.\n");
			break;

		//code cracking (a random code is generated, input correct number sequence to win)
		case 2:
			printf("Your job is find the correct number sequence in order to crack a safe\n"
			...
			while(hits<5)
			{
				...
				{
					if (j=0)
						printf("Enter your guess for the first digit: ");
					else
						printf("Enter your guess for the next digit: ");
...
void rbRoute(int* health, int* money, Inventory *inv)
{
	static int mem = 0;
	int choice = 0;
...
//Common intro to route
	...
	printf("Still disoriented from the accident, you begin stumbling along a path"
	       ...
	       " in the midst of a large, unfamiliar city. A glance to your right reveals"
	       ...
	       "in confusion, but accept the food. Only when you begin to eat do you realize"
	       " truly how hungry you were. You devour every last scrap ravenously. Still beside "
	       ...
	       "She pours two cups of tea, returns to your side, and hands you one before sipping"
	...
	printf("\e[1;33mSo it would seem you do have amnesia after all. Have you really no idea "
	       "whatsoever?\n");
	printf("\e[0mYou remain silent as you comb through your recent memories...\n");
...
//First time looping through this route, everyone will die.
	...
	if (mem==0)
	{
		printf("Realizing you truly have no memory of this place, you shake your head.\n"
		       ...
		       "been transported to an alternate reality: one where you live here"
		       ...
		       " again! Especially on Sandwich Sunday. You still haven't told us your secret"
		       ...
		       " with mostly normal banter. It's rather uncanny just how natural it all feels -"
		       ...
		       "reflected your own personality quite accurately. Johnny and Charlotte "
		       ...
		       "of evildoers and the morally corrupt. You wouldn't want to associate "
		       ...
		       " you around the town, since you had no memory of it. Along the way, you'd pick"
		...
		for(l=0; l<4; l++)
		{
			printf("A new morning. You get dressed and go out to meet wiht Johnny\n");
			job(health, money);
		}

		printf("\e[1;33mGood work, lad.\n");
		printf("\e[0mJohnny rests a hand upon your shoulder. He's beaming. You inquire"
		       " as to what may be the source of his present joviality.\n");
		printf("\e[1;33mI've just received an incredibly favourable promotion! This will"
		       " assuredly prove to be a massive boon for our finances.\nTonight, we party!\n");
		printf("\e[0mAs though on queue, Charlotte appears carrying one of Johnny's finest bottles"
		       " of champagne. She pops the cork. A fountain of fizz sprouts from the bottle's"
		       " opening, showering down upon everyone. The three of you cheer.\n"
		       "You play all sorts of games. Limbo, monopoly, twister, Uno, MarioKaretcc.");
		...
		printf("\e[0mYou fall asleep just like that.");
		festival(money, inv);
		...
		printf("You return from the festival late at night, completely exhausted.\n"
            "The next morning, with the sun still yet to rise, you were roused "
		       "from your sleep. You see Johnny standing before you, a grim expression"
		       " upon his face.\n"
		       ...
		       " from behind, and you're dragged out into the field beside the pond. You face "
		       "Charlotte. She had seemed relatively composed before, but now she begins to panick.\n"
		       "\e[1;33mOf course, you'd never spill the secrets of your own accord. But if we hang"
		       " the life of someone close to you in the balance, we just may get a squawk out of ya!"
		       "\e[0mThe man holding the gun snickers, then beckons another one of the goons forwards."
		       "A knife is pressed against your throat, cutting ever so gently. You feel a warm trail"
		       ...
		       "He just killed Charlotte, but it hasn't really registered yet.\nYou take his hand. He"
		       " guides you as though you were a marionette, and before you know it, your own hand "
		       "is pulls the trigger on the last goon.\nHe had been on his knees, begging for mercy."
		       ...
		       "It's worth more than any life. I'm just glad I got to save yours...\n"
		       "\e[0mJohnny worked at the cheese production plant, and recently was promoted to "
		       "executive manager of dairy. He abused this position to deal raw milk on the streets, "
           ...
           else
           {
             printf("You just can't bring yourself to pull the trigger. You've been through enough"
                    ...
                    "figure. His influence is so strong that the dairy company won't even dare to "
                    "fire him for the abuse of their product. But in the end, he always supported you."
                    "It felt in every way a contradiction. All were expendable to Johnny when it came"
                    ...
                    "acquire Johnny's milk supply, destroy the empire he built and erect yourself "
             ...
             else
             {
               printf("You genuinely pop Johnny with your shot and he dies instantly. However, as you"
                      ...
                      "to die a painful death, drowned in scalding milk. The one thing you sought, now"
                      "presented to you in abundance... and yet, you exit this world before you may partake\n");
             }
           }
...
//Second time looping through this route. Can save Charlotte if have umbrella. Can't save Johnny.
	...
	{
		printf("Scattered images flash through your mind. The scent of grilled cheese, "
		       "the barrel of a gun fixed upon a pleading soul, the heavy downpour of"
		       ...
		       "shoulder. The hand of a dead man. A man you once called friend. A man you "
		       "loved. A man you loathed. Confusion besets your mind as you struggle with your"
		       " emotions. You grow tense, fists clenched, anger boiling within. This man..."
		...
		if (choice==2)
		{
			...
			if (choice == 2)
			{
				printf("You hesitate for a brief moment, but then your rage swells up again. You ram your"
				...
				if (inv -> EB == 1)
				{
					...
					printf("Stay with Charlotte? (1) Yes\n(2) No\n");
					choice = inp(1,1,2);
					...
					if (choice == 1)
					{
						...
						printf("You spend the next three years living with Charlotte. By now,"
			...
			else
			{
				printf("You calm yourself. You've returned to a time before he ran your life to ruin.\n"
				       ...
				       "understandably so. With a situation like this, you can't help but wonder if you "
				...
				if (choice == 1)
				{
					printf("You stop by a local deli before heading to the park. You set up at a bench"
					       ...
					       " from her assault to no avail. Ultimately, you give in and allow her to feed you"
				...
				printf("Johnny greets the two of you upon your return. You hand him the package, "
				       "and he gives you your payment of$25");
				*money += 25;

        printf("You spend the next couple of days working like usual.\n");
	     	for(l=0; l<3; l++)
	    	{
	      		printf("A new morning. You get dressed and go out to meet wiht Johnny\n");
	      		job(health, money);
	    	}
        printf("A feeling of dread fills your stomach. The day had come where Johnny boasted about his"
               " new promotion. The position of power that he'd inevitably abuse to become a dairy "
        ...
        printf("Now you turn to Charlotte, expression grim. You tell her that Johnny has likely"
               " entered the field of dark dairy dealings. The best option for the both of you is"
               ...
               "They struck before dawn last time, so they'd leave right at midnight.");
               
               
          printf("Midnight arrives. It's raining. You creak the front door to the penthouse open and"
        ...
        else
        {
           printf("You attempt to create a distraction by sprinting towards that spies, allowing"
                  " Charlotte to slip away unnoticed... Or so you though. You got shot in the "
                  "leg and collapsed to the ground. Charlotte cried out to you out of concern,"
                  " unintentionally blowing her own cover.\nYou struggle back onto your feet"
...
//third loop - can save Johnny with grilled cheese.
		else
		{
			printf("Images flash through your mind once more. Scenes of death. Of sorrow. Of pain.\n"
			       ...
			       " The complete inverse of the temporal experience: to know one's future whilst "
			       ...
			       "You tell her you've been knocked out for three days, information you could not have already "
			       ...
			       "that existed in her memory. She looks up at you. You turn your head away, unable to bare"
			       ...
			       "I still mean something to you... after all, you mean so much to me.\n"
			       ...
			       " that promotion is what turned him fully to the black milk market. If you can convince him not"
			...
			job(health, money);
			printf("Today you go to work early so that you may confront Johnny later.\n");
			job(health, money);
			printf("You meet with Johnny during his lunch break. You tell him you know about the cheese factory."
			       ...
			       "\e[0mYou nod slowly. Though you confronted him about his ill-intentions, he dodged that "
			       "point and simply redirected the conversation. You won't let him get away with this.\n"
			       ...
			       "\e[0mHe defers merely to logic, but you can't get a read on his own view on the matter.\n"
			       ...
			       " job tomorrow. You'll figure out how to correct Johnny's future, but it'll require patience.");
			job(health, money);
			printf("After work, Charlotte approaches you. The two of you have been discussing potential strategies"
			       " for changing Johnny's path through the future. Your new plan hinges upon Sandwich Sunday."
			       "The first time you woke up here, Johnny mentioned how deligthful your grilled cheese sandwiches"
			       " were. Perhaps the joy of cheese will ignite a passion for protecting the dairy arts, as "
			...
			if (inv -> GC == 1)
			{
				printf("You hand Charlotte the the grilled cheese you found on one of your previous adventures.\n"
               ...
               "running a series of intensive chemical tests. You won't see the results for another 24 "
               ...
               festival(money, inv);
               printf("The sun sets in the distance, and the time for the fireworks display approaches.\n"
                      "Then you spot him, rushing over to meet the two of you.\n\e[1;33mForgive me, work"
                      " at the dairy plant ran a bit late!\e[0m\nYou suppress the urge to start cheering."
                      ...
                      " it to Johnny. Charlotte had convinced him to stay home for Sandwich Sunday, promsing"
                      ...
                      " essence of dairy! This is life itself!\nYou hand him the printed recipe, and he vows"
			...
			{
           printf("Despite your efforts to come up with a grilled cheese recipe that might conquer"
                  " Johnny's terrible temptation to dairy dealing delight, neither you or Charlotte"
                  " succeed. Before you know it, it's the night of Johnny's promotion. You know already"
                  " how to next two days will go.\n");
           festival(money, inv);
           printf("You return home. The next morning, you are roused by Johnny. You don't ask any questions"
                  ...
                  " who, just like the other time, are trying to get the milk supply's location out of her.\n"
                  "You walk up to them so casually they don't even bat an eye. You wrap your arm around one's"
                  "neck, securing a choke-hold, and point a gun at him with your free hand. He's now your "
                  ...
                  "to succesfully close the distance. You stab like prime John Wick with he umbrella and "
                  "completely penetrate the first goon.\nTwo to go.\nYou roll for cover, and engage in a shootout"
                  " with the other two. You manage to get another one down, but the last guy nails you in the "
                  "shoulder.\nYou can't raise your shooting arm anymore. You become desperate. Then he lunges for"
                  " Charlotte, likely intending to use her as a human shield. You leap out to defend her, but his"
                  " gun is already aimed at your position.\nYou've screwed up.\nJust then, Johnny leaps in front"
                  " of you, taking the bullet meant for you. You fire, hitting the final goon, then run to Johnny's"
    ...
    {
      printf("No plan that you or Charlotte devise is succesful. Johnny becomes a tyrant. Charlotte"
             " is executed. You return to your own world, a failure. You pray you never return here"
