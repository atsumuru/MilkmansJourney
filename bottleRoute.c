  ...
  */
  ...
  if(playerSelect ==1)
    ...
    if(randNum == 1)
      {
      printf("Triggered outcome 1\n");
      printf("\e[1;33m As you cross into the chasm. the rope snaps! you fall down and take some \e[1;31mdamage \e[1;33mand climb back out the other side\n");
      }
    else if(randNum==2)
      {
      printf("Triggered outcome 2\n");
 ...
 // printf("Goblins Mug you, what do to?\n");
  ...
  if(playerSelect ==1)
    ...
    if(randNum == 1)
      ...
      {
       printf("Triggered outcome 3\n");
       printf("\e[1;33mYou lose! the goblins planned an ultimate combo that resulted in you drawing 50 cards!!! Laughing and rolling on the floor, you notice the perfect opportunity to sneak past.\n");
      }
  ...
  if(playerSelect ==1)
    ...
    if(randNum == 1)
      {
      printf("Triggered outcome 1\n");
      printf("\e[1;33mYou try to grab the swinging axe as it comes down, you catch it, causing it to become dislodged from its handle, you then swing it into its gearbox, jamming the system to a standstil.\n");
      }
    else if(randNum==2)
      {
      printf("Triggered outcome 2\n");
