...
void sceneOne(int *h, int *m, FILE* f) 
{
	printf("You walk up some stalls that look like they were made by a groups of 10 year olds when you hear a commotion up ahead. You turn "
				...
				"path.\n\n"); 
  fprintf(f, "You walk up some stalls that look like they were made by a groups of 10 year olds when you hear a commotion up ahead. You turn "
				"the corner to see two stallowners arguing in the middle of the pathway. Their endless back and forth is taking up the whole "
				"path.\n\n"); 
	...
	{ 
      ...
      fprintf(f, "You decide to go around. \n\n");
        ...
        fprintf(f, "You try squeezing past them, but as you do, they get into a heated argument and start fighting. You catch a random stray "
							"to the cheek, easily leaving a bruise on your supple face. You quickly scuttle out of the way, cupping your cheek.\n");
				*h = -5; 
			}
			else 
        ...
        fprintf(f, "You slowly back up and go down another path.\n");
			} 
		}
		else if(c == 2) 
		{
      ...
      fprintf(f, "You decide to de-escalate the situation. \n\n"); 
			if(skill_check < 6)
			{
				printf("You try to talk the storeowners down, but they're too deep in their spat to recognize your presence.\nWell, that was "
							"useless.\n"); 
        fprintf(f, "You try to talk the storeowners down, but they're too deep in their spat to recognize your presence.\nWell, that was "
							"useless.\n");
				c = 0; 
			} 
			else 
        ...
        fprintf(f, "You interupt their argument and start giving a speech about kindness and the importance of helping one another."
							"Your speech brings a tear to their eyes as they look at each other and hug it out. They then walk away, "
							"arm over the\nother's shoulder.\nYou always did had a way with words.\n\n");
			} 
		}
      ...
      fprintf(f, "You decide to tell them to move. \n\n");
			if(skill_check < 3)
			{
				printf("You tell them to move their @sses out of the way. They immediately stop arguing and glare at you. They turn back to each "
							...
							"path's free.\n"); 
        fprintf(f, "You tell them to move their @sses out of the way. They immediately stop arguing and glare at you. They turn back to each "
							"and shake hands. You raise your eyebrow in confusion before they both punch you in face, knocking you onto the ground."
							"\nThe stallowners then turn and walk away while you wipe the blood from your nose.\nWell, on the bright side, the "
							"path's free.\n");
				*h = -10;
        ...
        fprintf(f, "You yell at them to move outta the way and they jump in surprise. Red flushes their faces as they scurry out of the way in "
				"embarrassment.\nPeople these days just don't have any common sense.\n\n");
			}
		} 
	} 
...
void sceneTwo(int *h, int *m) 
{
  ...
  fprintf(f, "As you walk down the stalls, you hear a loud crash as metal trashcan falls over in the way. A raccoon crawls out, "
				"chewing on a old bone. It spots you and drops the bone, growling fiercly. You try to back away but it just growls\n"
				"louder.\nSeems you're not getting out of this without some kind of altercation.\n\n");
    ...
    fprintf(f, "You decide to fight the raccoon. \n\n" 
      ...
      fprintf(f, "Raccoon - HP: %d\n\n", enemy_hp);
        ...
        fprintf(f, "You attack and do %d damage.\n", skill_check);
				if(skill_check >= 8)
				{ 
					printf("Critical Hit!!\n"); 
          fprintf(f, "Critical Hit!!\n");
				}
				if(enemy_hp < 1)
				{
					break;
      ...
      fprintf(f, "The raccoon was defeated\n\nIt falls flat on the ground as it shakes its head. You growl at it and it "
						"quickly scrambles to its feet and scampers away. You puff out your chest and put your hands on your "
						"hips triumphantly, basking in your victory.\n\nYou wonder if this counts as animal cruelty.\n");
		}
		else if(action == 2)
      ...
      fprintf(f, "You decide that the fight wasn't worth it and stop, being the bigger man. Unfortunately, your "
						"opponent is a wild raccoon. It scratches and bites you before running off.\nNext time, keep in mind "
						"that animals do not follow the rules of engagement.\n");
			*h -= 15;
		} 
    ...
    fprintf(f, "You decide to pull your family's secret technique. \n"
		...
		if(skill_check > 5)
		{
			printf("You take off so fast that the raccoon doesn't have time to react.\nYour family's technique truly is "
						"unbeatable.\n"); 
      fprintf(f, "You take off so fast that the raccoon doesn't have time to react.\nYour family's technique truly is "
						"unbeatable.\n");
		}
		else 
		{
      ...
      fprintf(f, "As you run away, you hear scampering behind you. You look behind you and see the raccoon right behind you."
						"\nYou scream in panic as you trip on a random rock and tumble into a large bush. Thankfully, this allows you "
						"lose the raccoon, at the cost of a few scratches.\n");
			*h = -3;
		}
...
{ 
    ...
    fprintf(f, "You pass by an empty dirt path. Strange, but you feel like something's supposed to be there.\n"); 
	} 
	else
	{
		printf("You pass by a dirt path and see an old man struggling to take back his bag from a stray dog.\n"); 
    fprintf(f, "You pass by a dirt path and see an old man struggling to take back his bag from a stray dog.\n");
...
void sceneFive(int *h, int *m, FILE* f) 
{
  ...
  fprintf(f, "You stare confused at a sign for a stall, unable to discern the gibberish scrawled across it. As you puzzle it over "
				"in your mind, you feel something small slip into your pocket and grab your wallet. You spin around and see a little\n"
				"kid trying to pickpocket you. You grab their hand and pull out their hand, still holding your wallet. They cower a "
				"bit with fearful eyes.\n");
    ...
    fprintf(f, "You decide to yeet the child. \n\n" 
      ...
      fprintf(f, "You manage to get away from the angry mob.\nSome people seem really sensitive nowadays.\n");
		}
		else
		{
			printf("The mob quickly surrounds you and proceeds to beat you within an inch of your life.\nHonestly, what did you expect "
						"would happen?\n"); 
      fprintf(f, "The mob quickly surrounds you and proceeds to beat you within an inch of your life.\nHonestly, what did you expect "
						"would happen?\n");
			*h = -15; 
		}
	} 
